<?php $cat = get_field('content_hub')['categories'][0]['category'];
$featuredID = get_field('content_hub')['categories'][0]['featured_post']; ?>
<script type="text/javascript" id="incompass-fp-js-extra">
/* <![CDATA[ */
var icfp = {"restUrl":"https:\/\/www.incompasshs.org\/wp-json\/","videoId":null,"contentHubCats":[{"category":<?php echo $cat ?>,"featured_post":<?php echo $featuredID ?>}]};
/* ]]> */
</script>
<?php get_header(); ?>

    <div id="main-content">
        <?php get_template_part('partials/front-page-hero', 'image'); ?>
        ...
        <?php if (get_field('careers')['section_title']) {
            ...
            <section class="fp-careers">
                <div class="container">
                    ...
                    ?>
                    <?php if(get_field('careers')['section_footer']){ ?><div class="careers-body"><?php echo get_field('careers')['section_footer'] ?></div><?php }?>
                </div>
            </section>
            <?php
        } ?>
