...
<section class="d-md-flex relative">
    ...
    <div class="w-md-50 text-white text-center bg-purple">
        <div class="py-8">
            ...
            <?php endif; ?>
            <div class="mb-4">
                <a href="<?php echo $link['url']; ?>" class="border border-white uppercase text-white py-2 px-4 fw-bold">
    ...
    <div class="w-md-50 text-deep-purple text-center bg-teal">
        <div class="py-8">
            ...
            <?php endif; ?>
            <div class="mb-4">
                <a href="<?php echo $link2['url']; ?>" class="border border-deep-purple uppercase text-deep-purple py-2 px-4 fw-bold">
